...
//		 */
//		loadPhotographyItems( 1000 );	// load all 0..871 items
//		//
//		int topN = 10;
//		//Article sum = catalog.stream().reduce((long)0, Article::sum);
//	    invValue = inventoryValue();
//		//System.out.println( pad( fmtPrice( invValue, "", " �" ), 14, true ) );
//		
...
////			  print( a );  
////			  preis = a.getUnitPrice();
////			  anzahl = a.getUnitsInStore();
////			  value = preis * anzahl;
////		}
...
//		List<Article> sorted = catalog.stream()
//				.sorted((a1, a2) -> {
//				long invent1 = a1.getUnitPrice() * a1.getUnitsInStore();
//				long invent2 = a2.getUnitPrice() * a2.getUnitsInStore();
//				if( invent1 == invent2) {
//					return 0;
//				} else if(invent1 < invent2) {
//					return 1;
//				}
//				return -1;
//				})
...
//				     .limit(n);
////			          .sorted((o1, o2)->o1.getUnitPrice().
////                       compareTo(o2.getUnitPrice()).
////                       collect(Collectors.toList())
//				
//                      
//	}
...
//			new Article( "8714574643373", "PowerShot SX620 HS - Wei� Essentials Kit", 22900, 27 ),
//			new Article( "4549292034615", "PowerShot G3 X", 89900, 54 ),
//			new Article( "4549292057423", "PowerShot SX620 HS - Wei�", 20900, 32 ),
...
//			new Article( "4549292100884", "Unterwassergeh�use WP-DC56", 39900, 0 ),
...
//			new Article( "4960999620855", "ACK-DC50 Netzger�t", 7900, 75 ),
//			new Article( "4960999676623", "CB-2LBE Akkuladeger�t", 5900, 5 ),
//			new Article( "4960999676692", "ACK-DC70 Netzger�t", 7900, 44 ),
//			new Article( "4960999795935", "ACK-DC80 Netzger�t", 7900, 65 ),
//			new Article( "4960999355221", "ACK-DC30 Netzger�t", 7900, 81 ),
//			new Article( "4960999782959", "DR-DC10", 3500, 84 ),
//			new Article( "4960999242453", "CB-2LVE Akkuladeger�t", 5900, 17 ),
//			new Article( "4960999661223", "ACK-DC60 Netzger�t", 7900, 20 ),
//			new Article( "4960999044910", "ACK-800 Netzger�t", 6900, 51 ),
//			new Article( "4549292020625", "CB-2LHE Akkuladeger�t", 5900, 14 ),
//			new Article( "4549292054446", "Netzadapter CA-DC30E", 5900, 51 ),
//			new Article( "4960999977324", "CB-2LFE Akkuladeger�t", 5900, 56 ),
//			new Article( "4960999571706", "ACK-DC40 Netzger�t", 7900, 100 ),
//			new Article( "4960999796130", "CB-2LCE Akkuladeger�t", 5900, 92 ),
//			new Article( "4960999571676", "CB-2LYE Akkuladeger�t", 5900, 77 ),
//			new Article( "4960999112237", "CA-PS 700 E Ladeger�t", 6900, 23 ),
//			new Article( "4960999355191", "CB-2LXE Akkuladeger�t", 5900, 95 ),
//			new Article( "4960999844169", "ACK-DC90 Netzadapter", 7900, 61 ),
//			new Article( "4549292009828", "CB-2LGE Akkuladeger�t", 5900, 65 ),
...
//			new Article( "8714574657387", "EOS 2000D Geh�use + EF-S 18-135mm f/3.5-5.6 IS STM Kit", 89900, 88 ),
//			new Article( "4549292111859", "EOS 2000D Geh�use + EF-S 18-55mm f/3.5-5.6 IS II Kit", 49900, 0 ),
//			new Article( "4549292091328", "EOS 200D Geh�use - Schwarz", 54900, 53 ),
//			new Article( "4549292091434", "EOS 200D Geh�use - Wei� + EF-S 18-55mm f/4-5.6 IS STM - Silber", 64900, 91 ),
//			new Article( "8714574657295", "EOS 2000D Geh�use + EF-S 18-55mm f/3.5-5.6 IS II Value Up Kit", 52900, 95 ),
//			new Article( "8714574657264", "EOS 2000D Geh�use + EF-S 18-55mm f/3.5-5.6 IS II Battery Kit", 51900, 48 ),
//			new Article( "8714574653563", "EOS 200D Geh�use - Schwarz + EF-S 18-55mm f/3.5-5.6 III + EF 75-300mm f/4-5.6 III", 91900, 30 ),
//			new Article( "4549292116571", "EOS 4000D Geh�use + EF-S 18-55mm f/3.5-5.6 III Kit", 39900, 77 ),
//			new Article( "8714574657448", "EOS 2000D Geh�use + EF-S 18-55mm f/3.5-5.6 IS II + EF 50mm f/1.8 STM Kit", 63900, 38 ),
//			new Article( "8714574657394", "EOS 2000D Geh�use + EF-S EF-S 18-55mm f/3.5-5.6 IS II + EF 75-300mm f/4-5.6 III Kit", 79900, 56 ),
//			new Article( "8714574657325", "EOS 4000 Geh�use + EF-S 18-55mm f/3.5-5.6 III + EF 75-300mm f/4-5.6 III Kit", 69900, 98 ),
//			new Article( "8714574657356", "EOS 4000D Geh�use + EF-S 18-55mm f/3.5-5.6 III Value Up Kit", 42900, 60 ),
//			new Article( "4549292091335", "EOS 200D Geh�use - Schwarz + EF-S 18-55mm f/4-5.6 IS STM - Schwarz", 64900, 96 ),
//			new Article( "8714574653594", "EOS 200D Geh�use - Schwarz + EF-S 18-135mm f/3.5-5.6 IS STM", 104900, 7 ),
//			new Article( "4549292111835", "EOS 2000D Geh�use", 39900, 75 ),
//			new Article( "8714574653501", "EOS 200D Geh�use - Schwarz + EF-S 18-55mm f/3.5-5.6 III + 100EG + 16GB + Objektivreinigungstuch", 64900, 47 ),
//			new Article( "4549292116564", "EOS 4000D Geh�use", 34900, 61 ),
//			new Article( "8714574653532", "EOS 200D Geh�use - Schwarz + EF-S 18-55mm f/4-5.6 IS STM + EF 50mm f/1.8 STM", 78900, 48 ),
//			new Article( "4549292092707", "EOS 200D Geh�use - Schwarz + EF-S 18-55mm f/3.5-5.6 III", 61900, 6 ),
//			new Article( "4549292091502", "EOS 200D Geh�use - Silber + EF-S 18-55mm f/4-5.6 IS STM - Silber", 64900, 56 ),
//			new Article( "8714574645957", "EOS 5D Mark IV Geh�use", 349900, 56 ),
//			new Article( "4549292083583", "EOS 77D Geh�use", 84900, 40 ),
//			new Article( "4549292083590", "EOS 77D Geh�use + EF-S 18-135mm f/3.5-5.6 IS USM (NANO)", 124900, 21 ),
//			new Article( "4549292096255", "EOS 77D Geh�use + EF-S 18-55mm f/4-5.6 IS STM", 94900, 94 ),
//			new Article( "8714574636351", "EOS 80D Geh�use", 118500, 10 ),
//			new Article( "8714574636429", "EOS 80D Geh�use + EF-S 18-55mm f/3.5-5.6 IS STM", 128500, 0 ),
//			new Article( "8714574636504", "EOS 80D Geh�use + EF-S 18-135mm f/3.5-5.6 IS USM (NANO)", 158500, 30 ),
//			new Article( "8714574651705", "EOS 80D Geh�use + EF-S 18-200mm f/3.5-5.6 IS", 163500, 40 ),
//			new Article( "8714574647975", "EOS 7D Mark II Geh�use + W-E1 DE", 161500, 98 ),
//			new Article( "8714574650647", "EOS 77D Geh�use + EF-S 18-135mm f/3.5-5.6 IS USM (NANO) Value Up Kit", 127900, 42 ),
//			new Article( "4549292083552", "EOS 800D Geh�use", 74900, 53 ),
//			new Article( "4549292083736", "EOS 800D Geh�use + EF-S 18-55mm f/4-5.6 IS STM", 84900, 31 ),
//			new Article( "8714574650494", "EOS 800D Geh�use + EF-S 18-200mm f/3.5-5.6 IS", 119900, 93 ),
//			new Article( "4549292083903", "EOS 6D Mark II Geh�use", 199900, 28 ),
//			new Article( "4549292084085", "EOS 6D Mark II Geh�use + EF 24-105mm f/3.5-5.6 IS STM", 239900, 97 ),
//			new Article( "8714574635309", "EOS 1D X Mark II Geh�use", 629900, 57 ),
//			new Article( "8714574627861", "EOS 5Ds Geh�use", 379900, 95 ),
//			new Article( "8714574628080", "EOS 5Ds R Geh�use", 399900, 69 ),
...
//			new Article( "4960999417264", "Blitzschiene SB-E2 f�r 580 EX II", 31500, 42 ),
//			new Article( "4960999417271", "Externes Blitzkabel OC-E3", 9500, 30 ),
//			new Article( "4960999501284", "Synchron-Verl�ngerungskabel, 300 cm", 7500, 8 ),
//			new Article( "4549292007749", "Macro Ring Lite MR-14EX II", 81500, 0 ),
//			new Article( "4960999635323", "Macro Ring Lite-Adapter 67", 7500, 24 ),
//			new Article( "4960999501277", "Synchron-Verl�ngerungskabel, 60 cm", 6500, 56 ),
...
//			new Article( "4960999612485", "CBC-E5 Autoladeger�t", 13900, 28 ),
...
//			new Article( "4960999627540", "CBC-E6 Autoladeger�t", 29500, 74 ),
...
//			new Article( "4960999677873", "Adapter f�r Gelatine-Filter-Halter TYP WII 52mm", 9900, 3 ),
...
//			new Article( "4960999420387", "Adapter f�r Gelatine-Filter-Halter Typ IV 77mm", 6500, 7 ),
//			new Article( "4960999420417", "Adapter f�r Gelatine-Filter-Halter Typ IV 67mm", 5900, 66 ),
...
//			new Article( "4960999581088", "R�ckdeckel E", 800, 53 ),
...
//			new Article( "4549292088366", "LEGRIA HF R806 - Wei�", 24900, 0 ),
//			new Article( "8714574648859", "LEGRIA HF R806 - Schwarz Essential Kit", 28900, 11 ),
//			new Article( "8714574648880", "LEGRIA HF R806 - Wei� Essential Kit", 28900, 40 ),
...
//			new Article( "4960999297897", "CB-2LWE Akkuladeger�t", 6900, 13 ),
...
//			new Article( "4549292097245", "EH31-FJ Schutzh�lle Plastik navy", 4700, 60 ),
//			new Article( "4549292085112", "EH30-CJ BW Kamerah�lle", 5500, 9 ),
...
//			new Article( "4549292085099", "EH30-CJ BLK Kamerah�lle", 5500, 21 ),
//			new Article( "4549292097153", "EH31-FJ Schutzh�lle Leder hellbraun", 5500, 10 ),
//			new Article( "4549292097207", "EH31-FJ Schutzh�lle Plastik gelb", 4700, 43 ),
//			new Article( "4549292100587", "EH31-FJ Schutzh�lle Plastik rot", 4700, 48 ),
//			new Article( "4549292097269", "EH31-FJ Schutzh�lle Plastik gr�n", 4700, 3 ),
//			new Article( "4549292097283", "EH31-FJ Schutzh�lle Plastik blau/weiss", 4700, 45 ),
//			new Article( "4549292097184", "EH31-FJ Schutzh�lle Leder dunkelbraun", 5500, 65 ),
//			new Article( "4549292097221", "EH31-FJ Schutzh�lle Plastik gold", 4700, 50 ),
//			new Article( "4549292097306", "EH31-FJ Schutzh�lle Plastik schwarz/gelb", 4700, 41 ),
...
//			new Article( "8714574630489", "SELPHY CP1000 - Wei�", 9900, 66 ),
//			new Article( "4549292091182", "SELPHY CP1300 - Wei�", 12900, 6 ),
...
//			new Article( "8714574532271", "DCC-CP2 Transporttasche - Wei�", 4700, 22 ),
...
//			new Article( "4549292066630", "PIXMA TS5051 - Wei�", 11500, 43 ),
...
//			new Article( "4549292092967", "PIXMA TS3150 - Wei�", 7500, 10 ),
//			new Article( "4549292090598", "PIXMA TS6150 - Schwarz", 13900, 22 ),
//			new Article( "4549292093308", "PIXMA TS8151 - Wei�", 19500, 85 ),
...
//			new Article( "4549292090659", "PIXMA TS6151 - Wei�", 13900, 85 ),
//			new Article( "4549292090840", "PIXMA TS5151 - Wei�", 10500, 88 ),
//			new Article( "4549292090741", "PIXMA TS5150 - Schwarz", 10500, 84 ),
//			new Article( "4549292036640", "PIXMA MG3650 - Rot", 8500, 23 ),
//			new Article( "4549292036473", "PIXMA MG3650 - Wei�", 8500, 70 ),
//			new Article( "4549292036305", "PIXMA MG3650 - Schwarz", 8500, 56 ),
//			new Article( "4549292041354", "PIXMA MX495 - Wei�", 9900, 61 ),
...
//			new Article( "4549292078664", "EOS M5 Geh�use - Schwarz", 97900, 16 ),
//			new Article( "4549292084832", "EOS M6 Geh�use - Silber + EF-M 18-150mm f/3.5-6.3 IS STM Kit", 104900, 78 ),
//			new Article( "4549292084764", "EOS M6 Geh�use - Silber + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 79900, 46 ),
//			new Article( "4549292084702", "EOS M6 Geh�use - Silber", 67900, 9 ),
//			new Article( "4549292109412", "EOS M50 Geh�use - Schwarz", 57900, 41 ),
//			new Article( "4549292108910", "EOS M50 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 69900, 86 ),
//			new Article( "4549292109498", "EOS M50 Geh�use - Schwarz + EF-M 18-150mm f/3.5-6.3 IS STM Kit", 94900, 81 ),
//			new Article( "8714574657660", "EOS M50 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM Value Up Kit", 72900, 21 ),
//			new Article( "4549292109009", "EOS M50 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 55-200mm f/4-6.3 IS STM Kit", 92900, 2 ),
//			new Article( "4549292109467", "EOS M50 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 22mm f/2 STM Kit", 84900, 76 ),
//			new Article( "8714574657639", "EOS M50 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM + Mount Adapter EF-EOS M + EF 50mm f/1. ", 96900, 65 ),
//			new Article( "4549292109528", "EOS M50 Geh�use - Wei.", 57900, 0 ),
//			new Article( "4549292109177", "EOS M50 Geh�use - Wei. + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 69900, 81 ),
//			new Article( "4549292109580", "EOS M50 Geh�use - Wei. + EF-M 18-150mm f/3.5-6.3 IS STM Kit", 94900, 5 ),
//			new Article( "4549292094206", "EOS M6 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 55-200mm f/4-6.3 IS STM Kit", 102900, 52 ),
//			new Article( "4549292084511", "EOS M6 Geh�use - Schwarz + EF-M 18-150mm f/3.5-6.3 IS STM Kit", 104900, 4 ),
//			new Article( "4549292084429", "EOS M6 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 79900, 25 ),
//			new Article( "4549292084344", "EOS M6 Geh�use - Schwarz", 67900, 96 ),
//			new Article( "8714574654553", "EOS M100 Geh�use - Grau + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 49900, 71 ),
//			new Article( "8714574654539", "EOS M100 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 49900, 66 ),
//			new Article( "4549292096903", "EOS M100 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 22mm f/2 STM Kit", 64900, 22 ),
//			new Article( "4549292093759", "EOS M100 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 55-200mm f/4-6.3 IS STM Kit", 72900, 57 ),
//			new Article( "4549292093650", "EOS M100 Geh�use - Schwarz", 37900, 32 ),
//			new Article( "4549292093896", "EOS M100 Geh�use - Wei� + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 55-200mm f/4-6.3 IS STM Kit", 72900, 2 ),
//			new Article( "4549292094022", "EOS M100 Geh�use - Grau + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 55-200mm f/4-6.3 IS STM Kit", 72900, 69 ),
//			new Article( "4549292093940", "EOS M100 Geh�use - Grau", 37900, 63 ),
//			new Article( "4549292093810", "EOS M100 Geh�use - Wei.", 37900, 51 ),
//			new Article( "4549292094244", "EOS M6 Geh�use - Silber + EF-M 15-45mm f/3.5-6.3 IS STM + EF-M 55-200mm f/4-6.3 IS STM Kit", 102900, 59 ),
//			new Article( "4549292078718", "EOS M5 Geh�use - Schwarz + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 109900, 21 ),
//			new Article( "8714574646589", "EOS M5 Geh�use - Schwarz + EF-M 18-150mm f/3.5-6.3 IS STM + Mount Adapter EF-EOS M Kit", 134900, 48 ),
//			new Article( "4549292078787", "EOS M5 Geh�use - Schwarz + EF-M 18-150mm f/3.5-6.3 IS STM Kit", 134900, 63 ),
//			new Article( "8714574654546", "EOS M100 Geh�use - Wei� + EF-M 15-45mm f/3.5-6.3 IS STM Kit", 49900, 27 ),
